...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        viewTl = new QGraphicsView(Orthog);
        ...
        viewBl = new QGraphicsView(Orthog);
        ...
        viewBr = new QGraphicsView(Orthog);
        ...
        viewAxial = new QGraphicsView(Transverse);
